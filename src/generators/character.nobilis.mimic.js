...
export default () => {
  ...
  const curse = getRandom([names.NOUN])

  return `${aVsAn(identity)} ${identity} who is the ${adjective} mimic/${type} who has stolen the estates of ${estatesString} and contains a cursed ${curse}`
}
